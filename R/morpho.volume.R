...
#'   
#' @param x Dataset with three columns (3 dimensions in the morphospace)
#' 
#' @param groups An optional factor defining groups
#'   
#' @return This function returns a list with two objects. The first object is the volume for the whole dataset. If groups have been selected, then it also returns a data.frame with the volumes by group and the percentage of the total volume occupied in the morphospace.
#'   
#' @examples
